...
class RevOptions(object):
    ...
    Instances of this group should be treated as if immutable.
    """
...
class VcsSupport(object):
    ...
    def unregister(self, cls=None, name=None):
        if name in self._registry:
            ...
            logger.warning('Cannot unregister because no group or name given')
...
class VersionControl(object):
    ...
    def get_netloc_and_auth(self, netloc, scheme):
        ...
        This is mainly for the Subversion group to override, so that auth
